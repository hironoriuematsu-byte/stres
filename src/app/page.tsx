    ...
    return (
      <Card style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 14, color: "#5B6B6A", lineHeight: 1.8, margin: 0 }}>
          ログインは成功しましたが、アカウントに所属企業・役割の情報が登録されていないため、画面を表示できません。お手数ですが、会社のストレスチェック担当者または実施者(産業医 上松 弘典)に、このメールアドレス({user.email})のプロフィール登録を依頼してください。
        </p>
      </Card>
    );
  }
    ...
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      <Card>
        ...
        <p style={{ fontSize: 14, color: "#5B6B6A", lineHeight: 1.8, margin: "0 0 16px" }}>
          厚生労働省「職業性ストレス簡易調査票」に準拠したストレスチェックシステムです(事業場ごとに57項目版・80項目版を選択できます)。アカウントは実施者(産業医)からの招待により発行されます。招待メールが届いている方は、メール内のリンクからパスワードを設定のうえログインしてください。
        </p>
        <Link href="/login">
          <button
            style={{
